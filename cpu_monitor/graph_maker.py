...
chunk_list_list = get_data_from_file(get_log_fp("logtest"))# chunk_list_list =[[{name: "bla"...}, {name: "blo"...}], [{name: "bla"...}, {name: "blo"...}]]
...
#for cpu_scatter in scatter_per_cpu_list:
#    plot(cpu_scatter)
#    time.sleep(1)


#We make one graph per cpu

#plot([Scatter(x=x_values, y=[1,2,3])])
